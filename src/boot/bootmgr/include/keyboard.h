...
#define KEY_BACK 0x1001
#define KEY_ENTER 0x1002
#define KEY_LEFT 0x1003
#define KEY_RIGHT 0x1004
#define KEY_UP 0x1005
#define KEY_DOWN 0x1006
#define KEY_INS 0x1007
#define KEY_DEL 0x1008
#define KEY_HOME 0x1009
#define KEY_END 0x100A7
#define KEY_PGUP 0x100B
#define KEY_PGDOWN 0x100C
#define KEY_LEFT_GUI 0x100D
#define KEY_RIGHT_GUI 0x100E
