...
#define PAGE_LOADED_PROGRAM 0x01
#define PAGE_OSLOADER 0x02
#define PAGE_BOOT_PROCESSOR 0x03
#define PAGE_BOOT_TABLES 0x04
#define PAGE_FIRMWARE_TEMPORARY 0x05
#define PAGE_FIRMWARE_PERMANENT 0x06
#define PAGE_SYSTEM_RESERVED 0x07
