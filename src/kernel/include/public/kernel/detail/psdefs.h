...
#define PS_STATE_PENDING_SUSPEND 8
#define PS_STATE_PENDING_TERMINATE 9

#define PS_CREATE_DEFAULT 0x0000000000000000
#define PS_CREATE_SUSPENDED 0x0000000000000001
