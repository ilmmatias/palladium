...
#define PS_WAIT_COMPLETION_NONE 0
#define PS_WAIT_COMPLETION_SIGNAL 1
#define PS_WAIT_COMPLETION_TIMEOUT 2
...
#define PS_INIT_ALERT_DEFAULT PS_INIT_ALERT_POOL_ALLOCATED
