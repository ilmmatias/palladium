...
#define KE_PANIC_PAGE_FAULT_NOT_HANDLED 7
#define KE_PANIC_NMI_HARDWARE_FAILURE 8
#define KE_PANIC_INSTALL_MORE_MEMORY 9
#define KE_PANIC_BAD_PFN_HEADER 10
#define KE_PANIC_BAD_POOL_HEADER 11
#define KE_PANIC_BAD_SYSTEM_TABLE 12
#define KE_PANIC_COUNT 13
