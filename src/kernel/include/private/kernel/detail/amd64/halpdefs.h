...
#define HALP_APIC_SPIV_MASK ~0xFFull
#define HALP_APIC_SPIV_ENABLE 0x100
#define HALP_APIC_SPIV_FOCUS_DISABLE 0x200
#define HALP_APIC_SPIV_EOI_BROADCAST_DISABLE 0x1000
