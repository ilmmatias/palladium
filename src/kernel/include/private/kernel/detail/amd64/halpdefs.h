...
#define HALP_EARLY_MAP_START 0xFFFF800000000000
#define HALP_EARLY_MAP_PAGES 0x1000
...
#define HALP_FEATURE_INVTSC (1ull << 10)
#define HALP_FEATURE_MONITOR (1ull << 11)
#define HALP_FEATURE_CMPCCXADD (1ull << 12)
#define HALP_FEATURE_RDRAND (1ull << 13)
#define HALP_FEATURE_RDSEED (1ull << 14)
#define HALP_FEATURE_PCLMULQDQ (1ull << 15)
#define HALP_FEATURE_MOVBE (1ull << 16)
#define HALP_FEATURE_MOVDIRI (1ull << 17)
#define HALP_FEATURE_MOVDIR64B (1ull << 18)
#define HALP_FEATURE_RDTSCP (1ull << 19)
#define HALP_FEATURE_RDPID (1ull << 20)
#define HALP_FEATURE_INVPCID (1ull << 21)
#define HALP_FEATURE_FSGSBASE (1ull << 22)
#define HALP_FEATURE_XSAVE (1ull << 23)
#define HALP_FEATURE_FMA (1ull << 24)
#define HALP_FEATURE_POPCNT (1ull << 25)
#define HALP_FEATURE_LZCNT (1ull << 26)
#define HALP_FEATURE_BMI1 (1ull << 27)
#define HALP_FEATURE_BMI2 (1ull << 28)
#define HALP_FEATURE_SHA (1ull << 29)
#define HALP_FEATURE_SHA512 (1ull << 30)
#define HALP_FEATURE_AES_NI (1ull << 31)
#define HALP_FEATURE_APX (1ull << 32)
#define HALP_FEATURE_SSE (1ull << 33)
#define HALP_FEATURE_SSE2 (1ull << 34)
#define HALP_FEATURE_SSE3 (1ull << 35)
#define HALP_FEATURE_SSSE3 (1ull << 36)
#define HALP_FEATURE_SSE41 (1ull << 37)
#define HALP_FEATURE_SSE42 (1ull << 38)
#define HALP_FEATURE_AVX (1ull << 39)
#define HALP_FEATURE_AVX2 (1ull << 40)
#define HALP_FEATURE_F16C (1ull << 41)
#define HALP_FEATURE_GFNI (1ull << 42)
#define HALP_FEATURE_SMAP (1ull << 43)
#define HALP_FEATURE_SMEP (1ull << 44)
#define HALP_FEATURE_UMIP (1ull << 45)
#define HALP_FEATURE_WAITPKG (1ull << 46)
...
#define HALP_SERIAL_REGISTER_DATA 0
#define HALP_SERIAL_REGISTER_INTERRUPT_ENABLE 1
#define HALP_SERIAL_REGISTER_FIFO_CONTROL 2
#define HALP_SERIAL_REGISTER_LINE_CONTROL 3
#define HALP_SERIAL_REGISTER_MODEM_CONTROL 4
#define HALP_SERIAL_REGISTER_LINE_STATUS 5

#define HALP_SERIAL_LINE_CONTROL_DLAB 0x80
#define HALP_SERIAL_LINE_CONTROL_8N1 0x03
#define HALP_SERIAL_FIFO_ENABLE_CLEAR 0x07
#define HALP_SERIAL_MODEM_DTR_RTS 0x03
#define HALP_SERIAL_LINE_STATUS_TX_EMPTY 0x20
#define HALP_SERIAL_LINE_STATUS_RX_READY 0x01
#define HALP_SERIAL_TX_POLL_LIMIT 100000
