...
#define MI_PROCESSOR_PAGE_CACHE_HIGH_LIMIT 128
#define MI_PROCESSOR_PAGE_CACHE_LOW_LIMIT 16
#define MI_PROCESSOR_PAGE_CACHE_BATCH_SIZE 32

#define MI_GLOBAL_KERNEL_STACK_CACHE_SOFT_LIMIT 128
#define MI_GLOBAL_KERNEL_STACK_CACHE_HARD_LIMIT 1024
#define MI_PROCESSOR_KERNEL_STACK_CACHE_HIGH_LIMIT 16
#define MI_PROCESSOR_KERNEL_STACK_CACHE_LOW_LIMIT 2
#define MI_PROCESSOR_KERNEL_STACK_CACHE_BATCH_SIZE 4
