...
function(add_executable target type has_lib)
    ...
    if(NOT (type STREQUAL "nostdlib" OR type STREQUAL "knostdlib"))
        ...
        elseif(type STREQUAL "osapi")
            target_link_libraries(${target} osapi)
        elseif(type STREQUAL "ucrt")
            target_link_libraries(${target} osapi ucrt ucrt_exe_startup)
        else()
            target_link_libraries(${target} osapi ucrt ucrt_exe_startup urt)
        endif()
    endif()
...
function(add_library target type)
    ...
    if(NOT (type STREQUAL "nostdlib" OR type STREQUAL "knostdlib"))
        ...
        elseif(type STREQUAL "osapi")
            target_link_libraries(${target} osapi)
        elseif(type STREQUAL "ucrt")
            target_link_libraries(${target} osapi ucrt ucrt_dll_startup)
        else()
            target_link_libraries(${target} osapi ucrt ucrt_dll_startup urt)
        endif()
    endif()
